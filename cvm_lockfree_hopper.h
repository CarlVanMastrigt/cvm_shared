...
bool cvm_lockfree_hopper_add(cvm_lockfree_hopper * hopper, cvm_lockfree_pool * pool, void * entry);/// returns true if it was added, false if not (fails if hopper is locked)
