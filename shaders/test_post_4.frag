...
void main()
{
        c_out=0.25*(subpassLoad(colour_input,0).rgb*(0.5+0.5*dot(0.57735026919.xxx,subpassLoad(normal_input,0).xyz*2.0-1.0))+
                    subpassLoad(colour_input,1).rgb*(0.5+0.5*dot(0.57735026919.xxx,subpassLoad(normal_input,1).xyz*2.0-1.0))+
                    subpassLoad(colour_input,2).rgb*(0.5+0.5*dot(0.57735026919.xxx,subpassLoad(normal_input,2).xyz*2.0-1.0))+
                    subpassLoad(colour_input,3).rgb*(0.5+0.5*dot(0.57735026919.xxx,subpassLoad(normal_input,3).xyz*2.0-1.0)));
}
