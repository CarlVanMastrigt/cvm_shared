...
static void cubic_shaded_element_box_constrained_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,overlay_colour colour,int16_t x_off,int16_t y_off,rectangle box_r,uint32_t box_status)
{
    ...
    if(r.x1<box_r.x1+radius && !(box_status&WIDGET_H_FIRST))///left applicable
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off,y_off_p,tile_x_pos-box_r.x1,tile_y_pos-box_r.y1);
        ...
        if(r.y2 > y1_p && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off,y_off_p);
        ...
        {
            cvm_render_shaded_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=r.y2}),colour,x_off,y_off_p,tile_x_pos-box_r.x1,tile_y_pos+diameter-box_r.y2);
        }
    ...
    if(r.x2 > r.x1 && x2_p > r.x1)///render middle section normally
    {
        ...
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=x2_p,.y2=r.y2}),colour,x_off,y_off);
    ...
    if(r.x2>box_r.x2-radius && !(box_status&WIDGET_H_LAST))
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour,x_off,y_off,tile_x_pos+diameter-box_r.x2,tile_y_pos-box_r.y1);
        ...
        if(r.y2 > r.y1 && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour,x_off,y_off);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_overlap_min_overlay_element(render_stack,bounds,r,colour,x_off,y_off,tile_x_pos+diameter-box_r.x2,tile_y_pos+diameter-box_r.y2);
        }
    }
}
                                                        ...
                                                        rectangle fade_bound,rectangle fade_range,rectangle box_r,uint32_t box_status)
{
    ...
    if(r.x1<box_r.x1+radius && !(box_status&WIDGET_H_FIRST))///left applicable
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_fading_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off,y_off_p,fade_bound,fade_range,tile_x_pos-box_r.x1,tile_y_pos-box_r.y1);
        ...
        if(r.y2 > y1_p && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off,y_off_p,fade_bound,fade_range);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_fading_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=r.y2}),colour,x_off,y_off_p,fade_bound,fade_range,tile_x_pos-box_r.x1,tile_y_pos+diameter-box_r.y2);
        }
    ...
    if(r.x2 > r.x1 && x2_p > r.x1)///render middle section normally
    {
        ...
        cvm_render_shaded_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=x2_p,.y2=r.y2}),colour,x_off,y_off,fade_bound,fade_range);
    ...
    if(r.x2>box_r.x2-radius && !(box_status&WIDGET_H_LAST))
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_fading_overlap_min_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour,x_off,y_off,fade_bound,fade_range,tile_x_pos+diameter-box_r.x2,tile_y_pos-box_r.y1);
        ...
        if(r.y2 > r.y1 && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour,x_off,y_off,fade_bound,fade_range);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_fading_overlap_min_overlay_element(render_stack,bounds,r,colour,x_off,y_off,fade_bound,fade_range,tile_x_pos+diameter-box_r.x2,tile_y_pos+diameter-box_r.y2);
        }
    }
}
...
static void cubic_fill_element_box_constrained_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,overlay_colour colour,rectangle box_r,uint32_t box_status)
{
    ...
    if(r.x1<box_r.x1+radius && !(box_status&WIDGET_H_FIRST))///left applicable
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off+r.x1-box_r.x1,y_off+y1_p-box_r.y1);
        ...
        if(r.y2 > y1_p && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_fill_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=r.y2}),colour,x_off+r.x1-box_r.x1,y_off+y1_p-box_r.y2+diameter);
        }
    ...
    if(r.x2 > r.x1 && x2_p > r.x1)///render middle section normally
    {
        ...
        cvm_render_fill_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=x2_p,.y2=r.y2}),colour);
    ...
    if(r.x2>box_r.x2-radius && !(box_status&WIDGET_H_LAST))
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_overlay_element(render_stack,bounds,(rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p},colour,x_off+r.x1-box_r.x2+diameter,y_off+r.y1-box_r.y1);
        ...
        if(r.y2 > r.y1 && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_fill_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_overlay_element(render_stack,bounds,r,colour,x_off+r.x1-box_r.x2+diameter,y_off+r.y1-box_r.y2+diameter);
        }
    }
}
                                                      ...
                                                      rectangle fade_bound,rectangle fade_range,rectangle box_r,uint32_t box_status)
{
    ...
    if(r.x1<box_r.x1+radius && !(box_status&WIDGET_H_FIRST))///left applicable
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,x_off+r.x1-box_r.x1,y_off+y1_p-box_r.y1,fade_bound,fade_range);
        ...
        if(r.y2 > y1_p && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_fill_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=y2_p}),colour,fade_bound,fade_range);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=y1_p,.x2=x2_p,.y2=r.y2}),colour,x_off+r.x1-box_r.x1,y_off+y1_p-box_r.y2+diameter,fade_bound,fade_range);
        }
    ...
    if(r.x2 > r.x1 && x2_p > r.x1)///render middle section normally
    {
        ...
        cvm_render_fill_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=x2_p,.y2=r.y2}),colour,fade_bound,fade_range);
    ...
    if(r.x2>box_r.x2-radius && !(box_status&WIDGET_H_LAST))
    {
        ...
        if(r.y1<y2_p)
        {
            ...
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,(rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p},colour,x_off+r.x1-box_r.x2+diameter,y_off+r.y1-box_r.y1,fade_bound,fade_range);
        ...
        if(r.y2 > r.y1 && y2_p > r.y1)///render middle section normally
        {
            ...
            cvm_render_fill_fading_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x2,.y2=y2_p}),colour,fade_bound,fade_range);
        ...
        if(r.y2>box_r.y2-radius)
        {
            cvm_render_shaded_fading_overlay_element(render_stack,bounds,r,colour,x_off+r.x1-box_r.x2+diameter,y_off+r.y1-box_r.y2+diameter,fade_bound,fade_range);
        }
    }
}
...
static void cubic_square_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour)
{
    ...
    if(!(status&WIDGET_H_FIRST))
    {
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=m-radius,.y1=r.y1,.x2=m,.y2=r.y2}),colour,x_off,y_off);
        r.x1=m;
    }

    if(!(status&WIDGET_H_LAST))
    {
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=m,.y1=r.y1,.x2=m+radius,.y2=r.y2}),colour,x_off+radius,y_off);
        r.x2=m;
    }
...
static void cubic_h_bar_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour)
{
    ...
    {
        r.x1+= cubic->foreground_offset_x;
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x1+radius,.y2=r.y2}),colour,x_off,y_off);
        r.x1+=radius;
    }
    ...
    {
        r.x2-= cubic->foreground_offset_x;
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x2-radius,.y1=r.y1,.x2=r.x2,.y2=r.y2}),colour,x_off+radius,y_off);
        r.x2-=radius;
    }
...
static void cubic_h_bar_slider_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour,int32_t before,int32_t bar,int32_t after)
{
    ...
    cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x1-cubic->internal_r,.y1=r.y1,.x2=r.x1,.y2=r.y2}),colour,(cubic->internal_image_tile->x_pos<<2),(cubic->internal_image_tile->y_pos<<2));

    cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=r.x2,.y1=r.y1,.x2=r.x2+cubic->internal_r,.y2=r.y2}),colour,(cubic->internal_image_tile->x_pos<<2)+cubic->internal_r,(cubic->internal_image_tile->y_pos<<2));
...
static void cubic_box_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour)
{
    ...
    if(!(status&WIDGET_H_FIRST))
    {
        ...
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=rv.x1,.y1=rv.y1,.x2=rv.x2,.y2=rv.y1+radius}),colour,x_off,y_off);
        rv.y1+=radius;

        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=rv.x1,.y1=rv.y2-radius,.x2=rv.x2,.y2=rv.y2}),colour,x_off,y_off+radius);
        rv.y2-=radius;

        cvm_render_fill_overlay_element(render_stack,bounds,rv,colour);
    }
    ...
    if(!(status&WIDGET_H_LAST))
    {
        ...
        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=rv.x1,.y1=rv.y1,.x2=rv.x2,.y2=rv.y1+radius}),colour,x_off+radius,y_off);
        rv.y1+=radius;

        cvm_render_shaded_overlay_element(render_stack,bounds,((rectangle){.x1=rv.x1,.y1=rv.y2-radius,.x2=rv.x2,.y2=rv.y2}),colour,x_off+radius,y_off+radius);
        rv.y2-=radius;
...
static void cubic_square_box_constrained_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour,rectangle box_r,uint32_t box_status)
{
    ...
    if(!(status&WIDGET_H_FIRST))
    {
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=m-radius,.y1=r.y1,.x2=m,.y2=r.y2}),colour,x_off,y_off,box_r,box_status);
        r.x1=m;
    }

    if(!(status&WIDGET_H_LAST))
    {
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=m,.y1=r.y1,.x2=m+radius,.y2=r.y2}),colour,x_off+radius,y_off,box_r,box_status);
        r.x2=m;
    }
...
static void cubic_h_bar_box_constrained_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour,rectangle box_r,uint32_t box_status)
{
    ...
    {
        r.x1+= cubic->foreground_offset_x;
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=r.x1,.y1=r.y1,.x2=r.x1+radius,.y2=r.y2}),colour,x_off,y_off,box_r,box_status);
        r.x1+=radius;
    }
    ...
    {
        r.x2-= cubic->foreground_offset_x;
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=r.x2-radius,.y1=r.y1,.x2=r.x2,.y2=r.y2}),colour,x_off+radius,y_off,box_r,box_status);
        r.x2-=radius;
    }
...
static void cubic_box_box_constrained_render(cvm_overlay_render_data_stack * restrict render_stack,overlay_theme * theme,rectangle bounds,rectangle r,uint32_t status,overlay_colour colour,rectangle box_r,uint32_t box_status)
{
    ...
    if(!(status&WIDGET_H_FIRST))
    {
        ...
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=rv.x1,.y1=rv.y1,.x2=rv.x2,.y2=rv.y1+radius}),colour,x_off,y_off,box_r,box_status);
        rv.y1+=radius;

        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=rv.x1,.y1=rv.y2-radius,.x2=rv.x2,.y2=rv.y2}),colour,x_off,y_off+radius,box_r,box_status);
        rv.y2-=radius;

        cubic_fill_element_box_constrained_render(render_stack,theme,bounds,rv,colour,box_r,box_status);
    }
    ...
    if(!(status&WIDGET_H_LAST))
    {
        ...
        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=rv.x1,.y1=rv.y1,.x2=rv.x2,.y2=rv.y1+radius}),colour,x_off+radius,y_off,box_r,box_status);
        rv.y1+=radius;

        cubic_shaded_element_box_constrained_render(render_stack,theme,bounds,((rectangle){.x1=rv.x1,.y1=rv.y2-radius,.x2=rv.x2,.y2=rv.y2}),colour,x_off+radius,y_off+radius,box_r,box_status);
        rv.y2-=radius;
